...
public class ComputeIconTestStatisticsBatch {
	...
	public static void main(String[] args) {
		...
		ComputeIconTestStatistics computeIconTestStatistics = (ComputeIconTestStatistics) context.getBean("computeIconTestStatistics");	
