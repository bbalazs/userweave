...
public class SingleAnswerConfUI  extends QuestionConfigurationBaseUI<QuestionWithMultiplePossibleAnswers> {
	...
	@SpringBean
	private QuestionWithMultiplePossibleAnswersDao dao;
	
	public SingleAnswerConfUI (
			String id,
			int configurationId,
			int questionId,
			Locale studyLocale,
			...
			ChangeTabsCallback changeTabsCallback) 
	{
		...
		addFormComponent(new SingleAnswerConfigurationPanel("panel", configurationId, questionId, studyLocale));
	}
...
//	}
	...
	@Override
	protected BaseDao<QuestionWithMultiplePossibleAnswers> getBaseDao() {
		return dao;
	}
}