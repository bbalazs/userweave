...
@Repository
@Transactional
public class MockupConfigurationDaoImpl extends StudyDependendDaoImpl<MockupConfigurationEntity> implements MockupConfigurationDao {

	@Override
	public Class<MockupConfigurationEntity> getPersistentClass() {
		return MockupConfigurationEntity.class;
	}
