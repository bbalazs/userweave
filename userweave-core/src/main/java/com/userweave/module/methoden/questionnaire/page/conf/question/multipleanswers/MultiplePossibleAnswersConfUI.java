 ...
 */
public class MultiplePossibleAnswersConfUI 
	extends QuestionConfigurationBaseUI<QuestionWithMultiplePossibleAnswers> 
{
	...
	public MultiplePossibleAnswersConfUI (
			String id,
			int configurationId,
			int questionId,
			Locale studyLocale,
			...
			ChangeTabsCallback changeTabsCallback) 
	{
		...
		addFormComponent(
				new MultipleAnswersConfigurationPanel(
						"panel", 
						configurationId, 
						questionId, 
						studyLocale));
