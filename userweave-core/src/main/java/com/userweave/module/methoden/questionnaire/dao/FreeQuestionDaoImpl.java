...
@Repository
@Transactional
public class FreeQuestionDaoImpl extends StudyDependendDaoImpl<FreeQuestion> implements FreeQuestionDao {
	
	@Override
	public Class<FreeQuestion> getPersistentClass() {
		return FreeQuestion.class;
	}	
}
