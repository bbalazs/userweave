...
@Repository
@Transactional
public class FreeTextConfigurationDaoImpl extends StudyDependendDaoImpl<FreeTextConfigurationEntity> implements FreeTextConfigurationDao {

	@Override
	public Class<FreeTextConfigurationEntity> getPersistentClass() {
		return FreeTextConfigurationEntity.class;
	}
