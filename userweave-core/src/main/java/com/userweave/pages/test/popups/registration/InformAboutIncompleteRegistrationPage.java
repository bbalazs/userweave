 ...
 *******************************************************************************/
package com.userweave.pages.test.popups.registration;
...
public class InformAboutIncompleteRegistrationPage extends WebPage {

	private AjaxLink yes;
	
	public InformAboutIncompleteRegistrationPage(final ModalWindow window)
	{
