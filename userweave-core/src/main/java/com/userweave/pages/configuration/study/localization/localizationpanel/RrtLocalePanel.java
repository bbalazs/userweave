...
public class RrtLocalePanel extends ModuleConfigurationLocalePanel
{
	private static final long serialVersionUID = 1L;

	public RrtLocalePanel(String id, List<Locale> locales,
	...
	protected IModel getEntityName(EntityBase entity)
	{
		return new StringResourceModel(
				...
				this, 
				null, 
				new Object[] {((RrtConfigurationEntity)entity).getName()});
	}
	...
	protected IModel getLabelForConfigurationRow(int index, int size)
	{
		...
		if(index == size -1)
		{
			return new StringResourceModel("postfix", this, null);
		}
		// prefix
		else if(index == size -2)
		{
			return new StringResourceModel("prefix", this, null);
		}
		// rrt term
		else
		{
			...
			String id, LocalizedString localeString, int index, Locale locale)
	{
		...
		textField.add(AjaxBehaviorFactory.getUpdateBehaviorForLocalizedString(
				"onblur", localeString, RrtLocalePanel.this));
