...
public class MultipleRatingQuestionLocalePanel extends QuestionLocalePanel
{
	private static final long serialVersionUID = 1L;

	public MultipleRatingQuestionLocalePanel(String id, List<Locale> locales,
	...
	protected IModel getLabelForQuestionSpecificTerm(int index, int size)
	{
		if(index == size - 1)
		{
			return new StringResourceModel("pol_one", this, null);
		}
		
		if(index == size - 2)
		{
			return new StringResourceModel("pol_two", this, null);
		}
			...
			String id, LocalizedString localeString, int index, Locale locale)
	{
		...
		textField.add(AjaxBehaviorFactory.getUpdateBehaviorForLocalizedString(
				"onblur", localeString, MultipleRatingQuestionLocalePanel.this));
