...
public abstract class LocaleGroupingPage extends BaseModalWindowPage
{
	private StudyLocalesGroupingPanel displayComponent;
	...
	public LocaleGroupingPage(Study study, final ModalWindow window)
	{
		...
		addToForm(displayComponent = new StudyLocalesGroupingPanel(
						"groupingPanel", 
						study, 
						study.getLocale(),
						callback));
