...
public class AntipdePairCsvColumn extends CsvColumn
{
	private final AntipodePair antipodePair;
	...
	public AntipdePairCsvColumn(String title, AntipodePair antipodePair)
	{
		super(title);
