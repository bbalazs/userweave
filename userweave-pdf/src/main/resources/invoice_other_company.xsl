  ...
  <xsl:template match="receipient">
    ...
    <xsl:template match="details">
        ...
        <fo:block 
	        ...
	        <fo:block>
	          <xsl:text>Your use of Usability-Methods.com</xsl:text>
	        </fo:block>
        </fo:block>
        ...
        <fo:block space-after="10pt">
            <xsl:text>
	          thank you very much for using Usability-Methods.com. We are glad 
	          that Usability-Methods.com provided an added value for you and 
	          you are hence willing to contribute financially to further 
	          development of this service.
	        </xsl:text>
        </fo:block>
        <fo:block space-after="10pt">
            <xsl:text>The amount of </xsl:text>
			...
			<xsl:value-of select="date"/>
			<xsl:text> agreed upon has already been paid. </xsl:text>
	    </fo:block>
		<fo:block space-after="10pt">
			<xsl:text>
	          The services provided are not subject to German VAT. Please note 
	          that the liability for payment of VAT may have passed to you under 
	          the legislation of your country of residence in your capacity
	          as recipient of the services.
	        </xsl:text>
        </fo:block>
